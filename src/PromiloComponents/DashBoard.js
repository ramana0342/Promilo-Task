...
const UserWelcomeCard = () => {
  return (
    <div className="card shadow-sm  col-12 col-sm-12 col-lg-12 col-md-12 ">
    ...
    <div className="card shadow-sm d-flex flex-row">
      <div className="card-body">
        ...
        <p className="text-muted mb-1">
          <span className='fw-bold'>Running low?<a href="#" className="text-primary">Notify admin</a> <span>now</span></span>
        </p>
      </div>
...
const UserPendingActionCard = () => {
  return (
    <div class="card shadow-sm mt-0  p-4 overflow-auto h-75  flex-grow-1 overflow-auto " >
      ...
      <div class="list-group" style={{ maxHeight: "340px", overflowY: "auto" }}>
...
const FrequentlyUsedCards = () => {
  return (
    <div className="card shadow-sm border rounded shadow-sm p-0  col-sm col-12">
      <h5 className="fw-bold mb-2">Frequently Used</h5>
          ...
          <div className="col-md-4 " key={index}>
            <div className="card border border-success-subtle rounded shadow-sm h-100">
              <div className="card-body position-relative p-0">
                ...
                <a href="#" className="text-primary fw-bold p-0 m-0 " style={{ position: "absolute", bottom: "0px" }}>
                  Get started &gt;&gt;
                </a>
              </div>
            </div>
